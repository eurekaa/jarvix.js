...
(function() {
  ...
  jarvix_module.define(['underscore'], function(u) {
    return {
      /**
      ...
      */
      ...
      each: function(list, iterator, context) {
        return u.each(list, iterator, context);
      },
      /**
      ...
      */
      ...
      map: function(list, iterator, context) {
        return u.map(list, iterator, context);
      },
      /**
      ...
      */
      ...
      reduce: function(list, iterator, memo, context) {
        return u.reduce(list, iterator, memo, context);
      },
      /**
      ...
      */
      ...
      reduce_right: function(list, iterator, memo, context) {
        return u.reduceRight(list, iterator, memo, context);
      },
      /**
      ...
      */
      ...
      find: function(list, iterator, context) {
        return u.find(list, iterator, context);
      },
      /**
      ...
      */
      ...
      filter: function(list, iterator, context) {
        return u.filter(list, iterator, context);
      },
      /**
      ...
      */
      ...
      where: function(list, properties) {
        return u.where(list, properties);
      },
      /**
      ...
      */
      ...
      find_where: function(list, properties) {
        return u.findWhere(list, properties);
      },
      /**
      ...
      */
      ...
      reject: function(list, iterator, context) {
        return u.reject(list, iterator, context);
      },
      /**
      ...
      */
      ...
      every: function(list, iterator, context) {
        return u.every(list, iterator, context);
      },
      /**
      ...
      */
      ...
      some: function(list, iterator, context) {
        return u.some(list, iterator, context);
      }
    };
  });
